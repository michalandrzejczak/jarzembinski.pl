			...
			<div id="rekomendacje-section">
				...
				<div className="content-container">
					<div className="person-wrapper">
						<img src={zzt} alt="Zygmunt Zmuda Trzebiatowski JPG"/>
						<h4 className="person-name">Zygmunt Zmuda Trzebiatowski</h4>
						<span className="person-whois">wiceprzewodniczący Rady Miasta Gdyni</span>
					...
					<div className="person-wrapper">
						<img src={pb} alt="Paweł Borkowski JPG"/>
						<h4 className="person-name">Paweł Borkowski</h4>
						<span className="person-whois">redaktor naczelny Jestem z Gdyni</span>
						<p className="description-wrapper">
					...
					<div className="person-wrapper">
						<img src={tp} alt="Tomasz Prabucki JPG"/>
						<h4 className="person-name">Tomasz Prabucki</h4>
						<span className="person-whois">przewodniczący Młodzieżowej Rady Miasta Gdyni III kadencji</span>
						<p className="description-wrapper">
